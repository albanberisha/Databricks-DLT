...
dataset_bookstore = '/Volumes/workspace/default/s3_volume/bookstore'
data_catalog = 'workspace'
# spark.conf.set(f"dataset.bookstore", dataset_bookstore)
import os
os.environ["DATASET_BOOKSTORE"] = dataset_bookstore
...
# except Exception as e:
#     print(f"Warning: Could not set Spark config 'dataset.bookstore'. Error: {str(e)}")
#     # Fallback to environment variable or other storage
#     import os
#     os.environ["DATASET_BOOKSTORE"] = dataset_bookstore
